export default class StoreObject extends Phaser.GameObjects.Sprite {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
       ...
       this.engine_coll=this.scene.add.text(-900,300,'Engines ',{font:'50px Arial',fill:'white'});
       ...
       this.Turbo_coll=this.scene.add.text(-900,500,'Turbo ',{font:'50px Arial',fill:'white'});
       this.Turbo_coll.setOrigin(0,0);

       this.Body_coll=this.scene.add.text(-900,600,'Body ',{font:'50px Arial',fill:'white'});
